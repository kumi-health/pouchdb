...
import { assign, nextTick, pick, filterChange, adapterFun, explainError, clone, parseUri, bulkGetShim, flatten } from 'pouchdb-utils';
...
function HttpPouch(opts, callback) {
  ...
  api._changes = function (opts) {
    ...
    // --
    // -- new version moved down, --PM@2018-01-20
    // --
    ...
    // --
    // -- query_params in body version, --PM@2018-01-20
    // --
    ...
    if (opts.query_params && typeof opts.query_params === 'object') {
      ...
      for (var param_name in opts.query_params) {
        ...
        if (opts.query_params.hasOwnProperty(param_name)) {
          // params[param_name] = opts.query_params[param_name];
          body[param_name] = opts.query_params[param_name];
        }
      }
    }
